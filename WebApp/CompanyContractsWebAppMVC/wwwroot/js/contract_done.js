...
function LoadContractData(contractId) {
    var sendUrl = 'http://localhost:5188/Contract/GetById?id=' + contractId;
    $.ajax(
        {
...
function Save() {
    ...
    var sendUrl = 'http://localhost:5188/ContractDone/Create';
    var sendMethod = 'POST';
...
function Delete(e) {
    if (confirm('Вы уверены?')) {
        var sendUrl = 'http://localhost:5188/ContractDone/Delete?Id=' + e.data.id;
...
$(document).ready(function () {
    ...
    grid = $('#grid').grid({
        primaryKey: 'id',
        dataSource: 'http://localhost:5188/ContractDone/GetByContractId?contractId=' + contractId,
        uiLibrary: 'bootstrap',
        columns: [
