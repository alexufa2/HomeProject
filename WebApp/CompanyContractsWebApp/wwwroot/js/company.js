...
$(document).ready(function () {
    grid = $('#grid').grid({
        ...
        columns: [
            ...
            { title: '', field: '', width: 34, type: 'icon', icon: 'glyphicon-list-alt', tooltip: 'Посмотреть товары', events: { 'click': function (e) { window.location.replace("/companies?id="+e.data.id) } } },
