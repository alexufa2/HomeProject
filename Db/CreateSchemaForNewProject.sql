...
-- Role: db_checker_user
DROP ROLE IF EXISTS db_checker_user;

CREATE ROLE db_checker_user WITH
  LOGIN
  NOSUPERUSER
  INHERIT
  NOCREATEDB
  ...
  NOREPLICATION
  NOBYPASSRLS
  ENCRYPTED PASSWORD 'SCRAM-SHA-256$4096:cpHloZopwM2X4xPeL8Bg9A==$fqiSkvKcWvN8+xlzjgg8bySirtbrZMdpSSopZs+rYP0=:vwZbAYua22lqvZsOqTYJmGCylq8pCp9tJBNDqpLKADQ=';

GRANT read_write TO db_checker_user;

COMMENT ON ROLE db_checker_user IS 'User for login in db';
